...
- **Premium Admin UI**: A dashboard that feels native to GeneratePress, designed for ease of use.
...
- **Theme**: [GeneratePress](https://wordpress.org/themes/generatepress/) (Active)
- **WordPress**: 6.0+
- **PHP**: 7.4+
